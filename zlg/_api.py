...
# 动态库名称, 需要放在当前脚本目录
_zlg_dll_file_name = '../ControlCAN.dll'
...
# for ControlCAN.dll
# 打开设备
c_open_device = _zlg_dll.VCI_OpenDevice
# 测试设备是否在线
c_is_device_online = _zlg_dll.VCI_

# 初始化某个通道
c_init_can = _zlg_dll.VCI_InitCAN
c_get_I_property = _zlg_dll.GetIProperty
c_release_I_property = _zlg_dll.ReleaseIProperty

c_get_device_info = _zlg_dll.VCI_GetDeviceInf
c_clear_buffer = _zlg_dll.VCI_ClearBuffer
c_read_channel_error_info = _zlg_dll.VCI_ReadChannelErrInfo
c_read_channel_status = _zlg_dll.VCI_ReadChannelStatus

# 启动已经初始化后的通道
c_start_can = _zlg_dll.VCI_Init
c_get_recv_num = _zlg_dll.VCI_GetReceiveNum
c_transmit = _zlg_dll.VCI_Transmit
c_receive = _zlg_dll.VCI_Receive
c_transmitFD = _zlg_dll.VCI_TransmitFD
c_receiveFD = _zlg_dll.VCI_ReceiveFD
# 复位已经初始化的通道，若要再次使用，需要调用_zlg_start_can
c_reset_can = _zlg_dll.VCI_ResetCAN


# 关闭已经打开的设备
c_close_device = _zlg_dll.VCI_CloseDevice
